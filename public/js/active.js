(function ($) {
  ...
  // :: 4.0 Testimonials Slider Active Code
  if ($.fn.owlCarousel) {
    $(".Ahmad-testimonials-slides").owlCarousel({
      items: 1,
      margin: 0,
      loop: true,
      dots: true,
  ...
  // :: 6.0 Masonary Gallery Active Code
  if ($.fn.imagesLoaded) {
    $(".Ahmad-new-arrivals").imagesLoaded(function () {
      ...
      // init Isotope
      var $grid = $(".Ahmad-new-arrivals").isotope({
  ...
  $("#sideMenuBtn").on("click", function () {
    $("#wrapper").toggleClass("Ahmad-side-menu-open");
  });
  $("#sideMenuClose").on("click", function () {
    $("#wrapper").removeClass("Ahmad-side-menu-open");
  });
